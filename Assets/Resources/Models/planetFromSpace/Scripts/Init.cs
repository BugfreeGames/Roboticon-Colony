...
public class Init : MonoBehaviour 
{
    ...
    public bool SunIsDirectional = true;
    public bool randomiseConstants = false;
    public bool scaleSunBrightness = true;
	...
	void Start () 
	{
        ...
        if(randomiseConstants)
        {
            m_waveLength.x = Random.Range(0.4f, 0.7f);
            m_waveLength.y = Random.Range(0.4f, 0.7f);
            m_waveLength.z = Random.Range(0.4f, 0.7f);
        }
    }
	...
	void InitMaterial(Material mat)
	{
        ...
        {
            Vector3 matToSunVect = (m_sun.transform.position - transform.position).normalized;
            mat.SetVector("v3LightPos", matToSunVect);
        }
